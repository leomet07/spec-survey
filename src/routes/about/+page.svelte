<svelte:head>
	<title>About - The Spectator Demographics Survey</title>
</svelte:head>
...
<main>
	<article>
		...
		<section>
			<h2>Privacy</h2>
			<p>
				This survey is optional, but highly encouraged, for all
				Stuyvesant students.
			</p>
			<p>
				Ancestry question response data is only revealed to the public
		...
		<footer>
			Built with &lt;3 by <a href="https://github.com/leomet07"
				>Lenny Metlitsky ('25)</a
			>, a Spectator Web editor
		</footer>
	</article>
</main>
