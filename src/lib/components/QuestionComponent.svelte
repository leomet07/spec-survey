...
<section>
    ...
    <AutoCompleteDropdown autoCompleteService={autoCompleteService} geocoder={geocoder} chosenPlaceStore={questionStore}/>

    <MapChooser chosenPlaceStore={questionStore} geocoder={geocoder} />
</section>